    ...
    return (
        <div className="flex flex-row w-full justify-between items-center h-14 relative pr-1 ">
            ...
            <div className="flex flex-row items-center flex-1 mx-4 min-w-0 min-[1200px]:ml-40 min-[1200px]:justify-center max-[1199px]:justify-start">
                ...
                <div className="flex flex-row bg-customgray p-3 rounded-[23px] justify-between hover:brightness-150 focus-within:outline-2 transition-all duration-600 w-full max-w-[480px] ">
            ...
            <div className="flex flex-row items-center gap-2 flex-shrink-0">
                ...
                <div className=" flex flex-row" >
                    <button className="hover:bg-customgray/70 w-10 h-8 flex items-center justify-center">
                        <FaMinus className=" brightness-75"/>
                    </button>
                    <button className="hover:bg-customgray/70  w-10 h-8  flex items-center justify-center">
                        <FaRegSquareFull className=" brightness-75"/>
                    </button>
                    <button className="hover:bg-amber-700/50 w-10 h-8  flex items-center justify-center">
