import { FaMinus, FaRegSquareFull, FaXmark } from "react-icons/fa6";
        ...
        <div className="flex items-center flex-col justify-center w-full h-full bg-gradient-to-t from-black to-customgray3 rounded-md">
            <div className="flex absolute top-0 w-full h-16 drag-region ">
                <div className="flex absolute right-0 top-2 flex-row" >
                    ...
                    <button onClick={handleMaximize} className="hover:bg-white/20 bg-customgray2/70 w-10 h-8  flex items-center justify-center">
                        <FaRegSquareFull className="size-3 brightness-75"/>
                    </button>
                    <button onClick={handleClose} className="hover:bg-amber-700/50 bg-customgray2/70 w-10 h-8  flex items-center justify-center">
                        <FaXmark className="text-xl brightness-75"/> 
                    </button>
                </div>
            </div>
            <div className="flex items-center justify-center w-md h-95 rounded-md bg-customgray2">
                <div className="flex flex-col items-center justify-center w-full h-full pb-[20%]">
                    <svg xmlns="http://www.w3.org/2000/svg" height="168px" width="559px" className="size-35 pt-12" version="1.1" viewBox="0 0 559 168">
